                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 py-16 md:py-20">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden border-2 border-white shrink-0">
                    ...
                    {/* Kolumna 4: Dołącz do Iskry (LOGIKA SUPABASE) */}
                    <div className="bg-white/[0.03] p-6 md:p-8 rounded-[32px] md:rounded-[40px] border border-white/5 h-fit">
                        ...
                        <form onSubmit={handleJoinClub} className="relative">
                            <input
                                type="tel"
                                value={phoneNumber}
                        ...
                        {status === 'error' && <p className="text-[10px] text-red-500 mt-2 font-bold uppercase">Błąd zapisu. Spróbuj później.</p>}
                    </div>
