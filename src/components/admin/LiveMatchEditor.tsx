...
export const LiveMatchEditor = () => {
    ...
    const handleStop = async () => {
        ...
        // 1. Zapisz do historii w Supabase
        ...
        <div className="bg-white rounded-[32px] md:rounded-[40px] p-5 md:p-8 shadow-2xl border border-slate-100 space-y-6 md:space-y-8 text-slate-900">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                    <button onClick={() => saveToDB({ status: 'live' })} className="flex-1 sm:flex-none p-4 bg-green-500 text-white rounded-2xl shadow-lg hover:scale-105 transition-all flex justify-center"><Play size={20} /></button>
